...
class Cursor(pg.sprite.Sprite):
    def __init__(self):
        self.default_image = prepare.GFX["cursor"]
        self.click_image = prepare.GFX["cursor-clicked"]
        self.bulldoze_image = prepare.GFX["bulldoze_cursor"]
        self.image = self.default_image
        self.rect = self.image.get_rect()
        
    def get_event(self, event):
        if event.type == pg.MOUSEBUTTONDOWN:
            if self.image != self.bulldoze_image:
